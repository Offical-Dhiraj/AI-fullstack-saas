...
import { Eraser, FileText, Hash, House, Icon, Image, Scissors, SquarePen, Users } from 'lucide-react';
...
const Sidebar = ({ sidebar, setSidebar }) => {
    ...
    flex-col justify-between items-center max-sm:absolute top-14 bottom-0 ${sidebar ? `translate-x-0` :
