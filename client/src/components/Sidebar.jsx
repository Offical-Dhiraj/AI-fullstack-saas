...
const Sidebar = ({ sidebar, setSidebar }) => {
    ...
    return (
        ...
        flex-col justify-between items-center max-sm:absolute top-14 bottom-0 ${sidebar ? 'translate-x-0' : 'max-sm:-translate-x-full'
                ...
                <div className='px-6 mt-5 text-sm text-gray-600 font-medium'>
                    {navItems.map(({ to, label, Icon }) => (
                        <NavLink
                            ...
                            className={({ isActive }) =>
                                `px-3.5 py-2.5 flex items-center gap-3 rounded transition ${isActive
