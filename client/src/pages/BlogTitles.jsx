...
const BlogTitles = () => {
  ...
  const blogCategory = ['General', 'Technology', 'Business', 'Health', 'Lifestyle', 'Eduction', 'Travel', 'Food']
    ...
    <div className='h-full overflow-y-scroll p-6 flex flex-col md:flex-row gap-6 text-slate-700'>
      ...
      >
        ...
        <button disabled={loading}
          type="submit"
          className='w-full flex justify-center items-center gap-2 bg-linear-to-r from-[#C341F6] to-[#8E37EB]
      ...
      {/* RIGHT */}
      <div
        className='w-full md:w-1/2 p-4 bg-white rounded-lg flex flex-col border border-gray-200 min-h-100'
      >
        <div className='flex items-center gap-3'>
